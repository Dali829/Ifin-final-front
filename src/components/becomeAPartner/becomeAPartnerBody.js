...
const BeComeAPartnerBody = () => {
    ...
    const fetchData =  () => {
        ServicesProduct.getAllProduct().then((res)=>setData(res.data.filter((item) => item.productCategory.title== "Become a Partner")));
...
export default BeComeAPartnerBody